...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i, bus_data in enumerate(buses_data):
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f"Created bus: {bus}"))
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"Created {bus.seat_capacity} seats for {bus}")
                )
        ...
        self.stdout.write(self.style.SUCCESS("\nCredentials:"))
        self.stdout.write(self.style.SUCCESS("Admin: admin / admin@1234"))
