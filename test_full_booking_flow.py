...
def test_booking_flow():
    ...
    if routes.exists():
        ...
        return False  # 3. Test bus and seat availability
    ...
    print(f"   - Bus: {new_booking.bus.name}")
